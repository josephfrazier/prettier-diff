...
module.exports = function ({ fromPath, toPath, fromContent, toContent, prettierOptions = defaultPrettierOptions}) {
  ...
  const patch = diff.createTwoFilesPatch(fromPath, toPath, fromPretty, toPretty);
